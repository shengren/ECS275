...
#if defined(_WIN32)
#  define GLEXT_GET_PROC_ADDRESS( fn )           wglGetProcAddress(fn)
#elif defined(linux)
#  define GLX_GLXEXT_LEGACY
#  include <GL/glx.h>
#  define GLEXT_GET_PROC_ADDRESS( fn )           glXGetProcAddressARB((GLubyte*)fn)
#endif
...
{
#ifndef __APPLE__
  // Get some OpenGL Extensions
  PFNGLBINDBUFFERPROC    glBindBuffer    = (PFNGLBINDBUFFERPROC)    GLEXT_GET_PROC_ADDRESS("glBindBuffer");
#endif
